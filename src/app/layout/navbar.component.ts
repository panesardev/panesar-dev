...
@Component({
  ...
  template: `
    <nav class="grid grid-cols-4 justify-center items-center max-w-2xl mx-auto">
      <a class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" routerLink="/">
        <i class="w-5 h-5">
      ...
      <a class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" routerLink="/projects">
        <i class="w-5 h-5">
      ...
      <a class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" [href]="blog.link" target="_blank">
        <i class="w-5 h-5">
      ...
      <a class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4"routerLink="/info">
        <i class="w-5 h-5">
