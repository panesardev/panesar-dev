...
@Component({
  ...
  template: `
    <nav class="grid grid-cols-4 justify-center items-center max-w-2xl mx-auto">
      <a aria-label="home" class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" routerLink="/">
        <i class="w-5 h-5">
        ...
        <span class="group-hover:block hidden absolute top-[50px] left-[50%] translate-x-[-50%] bg-base-2 text-primary px-3 py-1">Home</span>
      </a>
      <a aria-label="projects" class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" routerLink="/projects">
        <i class="w-5 h-5">
        ...
        <span class="group-hover:block hidden absolute top-[50px] left-[50%] translate-x-[-50%] bg-base-2 text-primary px-3 py-1">Projects</span>
      </a>
      <a aria-label="info" class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4"routerLink="/info">
        <i class="w-5 h-5">
        ...
        <span class="group-hover:block hidden absolute top-[50px] left-[50%] translate-x-[-50%] bg-base-2 text-primary px-3 py-1">Info</span>
      </a>
      <a aria-label="blog" class="group relative flex justify-center items-center cursor-pointer transition-colors px-6 py-4" [href]="blog.link" target="_blank">
        <i class="w-5 h-5">
        ...
        <span class="group-hover:block hidden absolute top-[50px] left-[50%] translate-x-[-50%] bg-base-2 text-primary px-3 py-1">Blog</span>
      </a>
    </nav>
  `,
})
